...
public class BorderDesignerApp extends JFrame {
    ...
    private void _createTable(ActionEvent e) {
        ...
        // Header renderer (simple fixed style)
        ...
        cellPopup.add(editBorders);
        cellPopup.add(copyBorders);
        cellPopup.add(pasteBorders);

        _table.setComponentPopupMenu(cellPopup);
    ...
    private void _editBordersForSelection() {
        ...
        MatteBorder current = _cellBorders.getOrDefault(first, new MatteBorder(0, 0, 0, 0, new Color(100, 100, 100)));
